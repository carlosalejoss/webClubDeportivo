...
public class HomeController {
    ...
    /**
     * Constructor con inyeccion de dependencias para inicializar todos los servicios y repositorios necesarios en el controlador.
     *
     ...
     * @param reservaClaseService Servicio para la gestion de reservas de clases.
    ...
    /**
     * Metodo para manejar la solicitud GET a la pagina principal.
     *
    ...
    /**
     * Metodo para manejar la solicitud GET a la pagina de exito en la reserva.
     *
     * @param session La sesion del usuario.
     * @return La vista "exitoReserva" que muestra un mensaje de exito en la reserva.
     */
    @GetMapping("/exitoRsv")
    ...
    /**
     * Metodo para manejar la solicitud GET a la pagina de fallo en la reserva.
     *
     * @param session La sesion del usuario.
    ...
    /**
     * Metodo para manejar la solicitud GET a la pagina de inicio de sesion.
     *
     * @param session La sesion del usuario.
    ...
    /**
     * Metodo para manejar la solicitud GET a la pagina de registro de un nuevo usuario.
     *
     * @param session La sesion del usuario.
    ...
    /**
     * Metodo para manejar la solicitud GET a la pagina de datos de cuenta del usuario.
     *
     * @param session La sesion del usuario.
    ...
    /**
     * Metodo para manejar la solicitud GET a la pagina "Sobre Nosotros".
     *
     * @param session La sesion del usuario.
     * @return La vista "sobreNosotros", que describe la informacion sobre el club deportivo.
     */
    ...
    /**
     * Metodo para manejar la seleccion de tipo de campo por parte del usuario y mostrar las pistas disponibles.
     *
    ...
    /**
     * Metodo para redirigir a la pagina de seleccion de campo para Futbol 11.
     *
     * @param model El modelo de la vista.
     * @return La vista redirigida para la eleccion de campo de Futbol 11.
     */
    ...
    /**
     * Metodo para redirigir a la pagina de seleccion de campo para Futbol 7.
     *
     * @param session La sesion del usuario.
     * @return La vista redirigida para la eleccion de campo de Futbol 7.
     */
    ...
    /**
     * Metodo para redirigir a la pagina de seleccion de campo para Baloncesto.
     *
     * @param session La sesion del usuario.
     * @return La vista redirigida para la eleccion de campo de Baloncesto.
     */
    ...
    /**
     * Metodo para redirigir a la pagina de seleccion de campo para Tenis.
     *
     * @param session La sesion del usuario.
     * @return La vista redirigida para la eleccion de campo de Tenis.
     */
    ...
    /**
     * Metodo para redirigir a la pagina de seleccion de campo para Padel.
     *
     * @param session La sesion del usuario.
     * @return La vista redirigida para la eleccion de campo de Padel.
     */
    ...
    /**
     * Metodo para manejar el inicio de sesion del usuario.
     *
     * @param email El correo electronico del usuario.
     * @param password La contraseña del usuario.
     * @param session La sesion del usuario.
     * @param model El modelo para agregar atributos a la vista.
     * @return La vista redirigida segun el exito o error del inicio de sesion.
     */
    @PostMapping("/login")
    public String login(@RequestParam String email, @RequestParam String password, HttpSession session, Model model) {
        ...
        if (usuario == null) {
            model.addAttribute("error", "El correo ingresado no esta registrado.");
            return "iniciarSesion";
        } else {
            if (password.equals(usuario.getPassword())) {
                // Establece los atributos de sesion en funcion del rol del usuario
     ...
     * @param telefono El numero de telefono del nuevo usuario.
     * @param dni El DNI del nuevo usuario.
     * @param session La sesion del usuario.
     * @param model El modelo para agregar atributos a la vista.
     * @return La vista redirigida segun el exito o error del registro.
     */
    @PostMapping("/signUp")
    public String signUp(@RequestParam String email,
        ...
        if (email == null || email.trim().isEmpty() ||
            ...
            return "registrarse"; // Redirige de nuevo a la pagina de registro en caso de error
        }
        ...
        if (usuarioService.findByTelefono(telefono) != null) {
            model.addAttribute("error", "El telefono ya esta registrado.");
            return "registrarse"; // Redirige de nuevo a la pagina de registro en caso de error
        }
        ...
        nuevoUsuario.setPassword(password); // Asegurate de encriptar la contraseña antes de guardarla
        nuevoUsuario.setNombre(nombre != null ? nombre : ""); // Valores opcionales o vacios
        ...
        // Iniciar sesion para el usuario recien registrado
        ...
        return "redirect:/"; // Redirige a la pagina de inicio o a la pagina de bienvenida
    }

    /**
     * Metodo para cambiar la vista del usuario entre vista de administrador y vista normal.
     * Si el usuario es administrador, cambia el estado de "viewAsAdmin" en la sesion.
     *
     * @param session La sesion del usuario.
     * @return Redirige a la pagina de inicio.
     */
     ...
     * Invalida la sesion actual y redirige a la pagina de inicio.
     *
     * @param session La sesion del usuario.
     * @return Redirige a la pagina de inicio despues de cerrar sesion.
     */
    @GetMapping("/logout")
    ...
    /**
     * Metodo para mostrar las reservas de la semana actual.
     * Verifica que el usuario este logueado y muestra las reservas disponibles
     * en funcion de la pista seleccionada y la semana actual.
     *
    ...
    /**
     * Metodo para calcular el precio de la reserva dependiendo del tipo de pista seleccionada.
     *
     * @param pista El tipo de pista seleccionada.
     * @return El precio de la reserva segun el tipo de pista.
     */
     ...
     * Verifica que el usuario este logueado y que la fecha y hora seleccionadas sean validas.
     ...
     * @param session La sesion del usuario.
     * @param model El modelo para pasar datos a la vista.
     * @return La vista redirigida segun el exito o error al crear la reserva.
     */
    @PostMapping("/nueva")
    public String crearReserva(
        ...
        if (fechaParsed.equals(fechaActual)) {
            // Si es el mismo dia, verificar si la hora ya ha pasado
            ...
            // Si la fecha es anterior al dia actual, no se puede reservar
            return "redirect:/falloRsv";
        }
    ...
    /**
     * Metodo para mostrar las reservas del usuario para la semana actual.
     * Separa las reservas activas y no activas, y tambien muestra las reservas fuera de la semana actual.
     *
     ...
     * Elimina la reserva seleccionada y redirige al usuario a la pagina de sus reservas.
     *
     * @param model El modelo para pasar los datos a la vista.
     * @param session La sesion del usuario.
     * @param pista El ID de la reserva a eliminar.
     * @return La vista redirigida a la pagina de reservas del usuario.
     */
    ...
    /**
     * Metodo para gestionar las pistas. Obtiene todas las pistas y las agrupa por tipo,
    ...
    /**
     * Metodo para eliminar una pista seleccionada.
     * Elimina la pista correspondiente y redirige a la pagina de gestion de pistas.
     *
     * @param model El modelo para pasar los datos a la vista.
     * @param session La sesion del usuario.
     * @param nombrePista El nombre de la pista a eliminar.
     * @return Redirige a la pagina de gestion de pistas despues de eliminar la pista.
     */
    ...
    /**
     * Metodo para mostrar la vista de creacion de una nueva pista.
    ...
    /**
     * Metodo para guardar una nueva pista en la base de datos.
     * Crea una nueva pista con los datos proporcionados y asigna un numero de pista basado
     * en el tipo de pista. Luego, guarda la pista en la base de datos y redirige a la pagina
     * de gestion de pistas.
     *
     * @param nombre El nombre de la nueva pista.
     * @param tipo El tipo de la nueva pista.
     * @param descripcion La descripcion de la nueva pista.
     * @param model El modelo para pasar los datos a la vista.
     * @param session La sesion del usuario.
     * @return Redirige a la pagina de gestion de pistas despues de crear la nueva pista.
     */
     ...
     * Permite al usuario modificar su nombre, apellidos, correo electronico, telefono y contraseña.
     * Valida que al menos un campo sea cambiado y que los datos no esten duplicados en la base de datos.
     *
     ...
     * @param newTelefono El nuevo numero de telefono del usuario.
     * @param newPassword La nueva contraseña del usuario.
     * @param session La sesion del usuario.
     * @param model El modelo para pasar los datos a la vista.
     * @return Redirige a la pagina de datos de cuenta despues de actualizar los datos.
     */
    ...
    public String nuevosDatos(
        ...
        // Obtener el usuario actual desde la sesion
        Usuario usuario = (Usuario) session.getAttribute("usuario");
        ...
        if ((newEmail == null || newEmail.trim().isEmpty()) &&
            ...
            model.addAttribute("error", "Hay que rellenar minimo un campo para cambiar los datos.");
            return "datosCuenta"; // Redirige de nuevo a la pagina de registro en caso de error
        }
        ...
        // Actualizar la sesion con los datos modificados si es necesario
        session.setAttribute("usuario", usuario);
    ...
    /**
     * Metodo para mostrar todas las clases disponibles.
    ...
    /**
     * Metodo para mostrar las clases disponibles segun el tipo seleccionado.
     * Verifica que el usuario este logueado y filtra las clases por tipo, mostrando las disponibles
     * en la vista "reservarClases". Ademas, filtra los horarios segun la fecha y hora actuales.
     *
     * @param model El modelo para pasar los datos a la vista.
     * @param session La sesion del usuario.
    ...
    public String clasesReserva(Model model, HttpSession session, @RequestParam("tipo") String tipoSeleccionado) {
        ...
        // Filtrar las clases que no tienen horarios validos
    ...
    /**
     * Metodo para reservar una clase. Verifica si el usuario ya tiene una reserva en el mismo horario o si
     * el numero maximo de asistentes ya ha sido alcanzado. Si todo esta en orden, realiza la reserva.
     *
     * @param model El modelo para pasar los datos a la vista.
     * @param session La sesion del usuario.
     * @param horarioId El ID del horario de la clase que el usuario desea reservar.
     * @return Redirige a la pagina de exito o de fallo segun si la reserva fue exitosa o no.
     */
    ...
    public String apuntarseClase(Model model, HttpSession session, @RequestParam("horarioId") Long horarioId) {
        ...
        // Verificar si ya esta reservado por el usuario en el mismo horario
        ...
        // Verificar si el numero maximo de asistentes ya fue alcanzado
        ...
        if ((reservasActuales.size() + 1) > horario.getClase().getMaxAsistentes()) {
            session.setAttribute("tipoFallo", "No se ha podido completar la reserva ya que se ha alcanzado el numero maximo de asistentes a la clase.");
            return "redirect:/falloRsv";
        }
    ...
    /**
     * Metodo para mostrar las clases reservadas por el usuario. Filtra las clases activas y no activas de la semana
    ...
    /**
     * Metodo para eliminar una clase reservada por el usuario.
     *
     * @param model El modelo para pasar los datos a la vista.
     * @param session La sesion del usuario.
     * @param pista El ID de la clase a eliminar.
     * @return Redirige a la pagina de mis reservas despues de eliminar la clase.
     */
    ...
    /**
     * Metodo para gestionar todas las clases disponibles en el sistema.
    ...
    /**
     * Metodo para buscar clases por un rango de fechas. Filtra las clases segun las fechas de inicio y fin
     * y pasa los resultados al modelo para ser mostrados en la vista de resultados.
     *
     * @param model El modelo para pasar los datos a la vista.
     * @param fechaInicio La fecha de inicio del rango de busqueda.
     * @param fechaFin La fecha de fin del rango de busqueda.
    ...
    public String buscarClasesPorFechas(
        ...
        return "resultadoClases"; // Pagina de resultados
    }

    /**
     * Metodo para guardar los cambios en los datos de una clase.
     * Actualiza los detalles de una clase en la base de datos con la nueva informacion proporcionada por el usuario.
     *
     ...
     * @param descripcion La nueva descripcion de la clase.
     * @param maxAsistentes El nuevo numero maximo de asistentes.
     * @param precio El nuevo precio de la clase.
     * @return Redirige a la pagina de gestion de clases despues de guardar los cambios.
     */
    ...
    /**
     * Metodo para mostrar el formulario de edicion de una clase.
     * Obtiene los detalles de una clase especifica para mostrar en el formulario de edicion.
     *
     * @param id El ID de la clase que se va a editar.
     * @param model El modelo para pasar los datos a la vista.
     ...
     * @return Redirige a la pagina de gestion de clases despues de eliminar la clase.
     */
     ...
     * @param descripcion La descripcion de la nueva clase.
     * @param maxAsistentes El numero maximo de asistentes para la clase.
     * @param precio El precio de la nueva clase.
     * @return Redirige a la pagina de gestion de clases despues de crear la clase.
     */
    ...
    /**
     * Metodo para crear un nuevo horario para una clase.
     * Verifica que la clase exista y crea un nuevo horario asociado a esa clase.
     *
     * @param claseId El ID de la clase a la que se le asignara el nuevo horario.
     ...
     * @param model El modelo para pasar los datos a la vista.
     * @return Redirige a la pagina de gestion de clases despues de crear el horario.
     */
    ...
    public String crearHorario(
        ...
        if (clase == null) {
            ...
            return "redirect:/gestionarClases"; // Ajustar segun la vista de error
        }
     ...
     * Llama al servicio para enviar un correo de recuperacion de contraseña al usuario.
     *
     * @param email El correo electronico del usuario al que se le enviara el correo de recuperacion.
     * @return Devuelve una respuesta HTTP con el resultado del envio del correo.
     */
    ...
    /**
     * Metodo para mostrar el formulario de restablecimiento de contraseña.
     * Verifica si el token proporcionado es valido y muestra el formulario para restablecer la contraseña.
     *
     * @param token El token de restablecimiento de contraseña.
     * @param model El modelo para pasar los datos a la vista.
     * @return La vista para ingresar una nueva contraseña si el token es valido.
     */
    ...
    public String mostrarFormularioRestablecer(@RequestParam("token") String token, Model model) {
        ...
        if (usuario == null) {
            model.addAttribute("error", "El enlace de restablecimiento no es valido o ha expirado.");
            return "falloNuevaContrasegna"; // Pagina de error
        }
     ...
     * @param password2 La confirmacion de la nueva contraseña.
     * @param model El modelo para pasar los datos a la vista.
     * @return Redirige al inicio de sesion si la contraseña se actualiza correctamente.
     */
